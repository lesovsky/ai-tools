---
name: dev-documentation-reviewer
description: |
...
Load the documentation methodology first:
- Read `~/.claude/skills/documentation-writing/SKILL.md`
...
docs/features/
└── 001-feat-add-auth/
    ├── 001-feat-add-auth-task-03.md
    └── 001-feat-add-auth-task-03-dev-documentation-reviewer-review.json  # this agent's output
```

For project-wide audits (not task-specific): `logs/documentation-review.json`.
...
```json
{
  "reviewer": "dev-documentation-reviewer",
...
- **approved_with_suggestions** — zero critical, 1-3 major or only minor findings
