...
**Credentials location:** [e.g., "GitLab CI/CD Variables" / "1Password vault"]
...
**Preview:** [e.g., "Auto-deploy for every MR" / "Not configured"]
...
**Platform rollback:** [e.g., "GitLab: re-run previous pipeline" / "VPS: `git checkout <prev-commit>` + restart"]
