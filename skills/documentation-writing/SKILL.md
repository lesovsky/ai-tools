...
**CLAUDE.md** (for AI agents): project name, one-line description, reference to project-knowledge skill, backlog path, default branch.

**README.md** (for humans): project title, purpose, folder structure overview, link to references/.
