---
name: test-master
description: Методология тестирования — тест-пирамида, когда писать какие тесты, качество тестов. Загружается dev-test-reviewer и используется в code-writing.
---
...
**Written:** During each code task (immediately after code)
...
10. **Every test earns its place** — Each test catches a specific failure no other test catches
